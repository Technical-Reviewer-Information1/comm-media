(function () {
  ...
  function init() {
    ...
    Worksheet.make('wsBox', {
      name: 'comm-media',
      fields: [
        { id: 'm1', label: '① 伝えたいこと', hint: '一文で。', rows: 2, ph: '例：文化祭のクラス企画の開催時間が変わったこと' },
        { id: 'm2', label: '② 伝える相手', hint: '人数・年齢・その人たちがふだん使うもの。', rows: 2, ph: '例：クラス30人と、来場予定の保護者' },
        { id: 'm3', label: '③ 選んだメディアと理由', hint: '同期／非同期、1対1／1対多、記録が残るか。', rows: 3,
          ph: '例：クラスへは連絡アプリ（非同期・記録が残る）、保護者へは掲示（見に来た人全員に届く）' },
        { id: 'm4', label: '④ そのメディアの弱点', hint: '届かない人、誤解されやすい点。', rows: 3,
          ph: '例：連絡アプリを見ない人がいる／掲示は当日来ないと気づけない' },
        { id: 'm5', label: '⑤ 弱点をおぎなう工夫', hint: '複数のメディアを組み合わせる。', rows: 2,
          ph: '例：朝の会で口頭でも伝え、掲示は昇降口と教室の2か所に出す' }
      ],
      build: function (v, e) {
        return '<h4>メディア選択シート</h4><dl>' +
          '<dt>① 伝えたいこと</dt><dd>' + e(v.m1) + '</dd>' +
          '<dt>② 相手</dt><dd>' + e(v.m2) + '</dd>' +
          '<dt>③ 選んだメディアと理由</dt><dd>' + e(v.m3) + '</dd>' +
          '<dt>④ 弱点</dt><dd>' + e(v.m4) + '</dd>' +
          '<dt>⑤ おぎなう工夫</dt><dd>' + e(v.m5) + '</dd></dl>';
      },
      note: '「速く届く」「確実に届く」「記録が残る」は同時に満たしにくい——だから組み合わせます。'
    });
